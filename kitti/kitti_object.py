...
class kitti_object(object):
    ...
    def __init__(self, root_dir, split='training'):  # 'data/kitti/training'
    ...
    def get_lidar(self, idx):
        ...
        return utils.load_velo_scan(lidar_filename)     # '/frustum-convnet/data/kitti/training/velodyne/000000.bin'

    def get_calibration(self, idx):
        assert (idx < self.num_samples)
        calib_filename = os.path.join(self.calib_dir, '%06d.txt' % (idx))
        return utils.Calibration(calib_filename)        # '/frustum-convnet/data/kitti/training/calib/000000.txt'
