...
def compute_box_3d_obj_array(obj_array):
    ...
    return np.transpose(corners_3d, (1, 0))     # 将[[x1,y1,z1],[x2,y2,z2],...]转换为[[x1,x2,...],[y1,y2,...],[z1,z2,...]]
...
if __name__ == '__main__':
    ...
    if args.gen_val_det:
        ...
        if args.people_only:
            res_label_dir = ROOT_DIR + '/output/people_train/val_nms/result/data'
        elif args.car_only:
            res_label_dir = ROOT_DIR + '/output/car_train/val_nms/result/data'
        else:
            assert False
