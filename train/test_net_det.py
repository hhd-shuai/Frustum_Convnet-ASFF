...
def write_detection_results(output_dir, det_results):
    ...
    # there is a TXT file
    idx_path = '/home/b516/hhd_shuai/vscode_file/frustum-convnet/kitti/image_sets/%s.txt' % cfg.TEST.DATASET
...
def evaluate_py_wrapper(output_dir, async_eval=False):
    # official evaluation
    gt_dir = '/home/b516/hhd_shuai/vscode_file/frustum-convnet/data/kitti/training/label_2/'
    command_line = '/home/b516/hhd_shuai/vscode_file/frustum-convnet/train/kitti_eval/evaluate_object_3d_offline %s %s' % (gt_dir, output_dir)
...
def evaluate_cuda_wrapper(result_dir, image_set='val', async_eval=False):
    ...
    gt_dir = '/home/b516/hhd_shuai/vscode_file/frustum-convnet/data/kitti/training/label_2/'
    label_split_file = '/home/b516/hhd_shuai/vscode_file/frustum-convnet/data/kitti/%s.txt' % image_set
...
if __name__ == '__main__':
    ...
    if args.opts is not None:
        ...
        for substr in strs:
            substr = substr.split("=")
            liststr.extend(substr)
        merge_cfg_from_list(liststr)

    assert_and_infer_cfg()

    SAVE_DIR = os.path.join(cfg.OUTPUT_DIR, cfg.SAVE_SUB_DIR)       # 'output/car_train/val_nms'
    SAVE_DIR = os.path.join(ROOT_DIR, SAVE_DIR)                     # '/home/b516/hhd_shuai/vscode_file/frustum-convnet/output/car_train/val_nms'
    ...
    dataset_def = import_from_file(ROOT_DIR + "/" + cfg.DATA.FILE)
